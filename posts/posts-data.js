window.POSTS = [
  ...
  },
  {
    ...
    archiveTitle: "Qdrant in Production: A Practical Guide to Vector Databases for RAG Systems",
    archiveExcerpt:
      "Why dedicated vector databases can outperform managed search at scale, with notes on RRF, HNSW tuning, and quantization.",
  },
  {
    ...
    archiveTitle: "Quantization Theory - Why is quantization so Important?",
    archiveExcerpt:
      "A practical breakdown of quantization error, outliers, and the deployment tradeoffs behind LLM.int8(), GPTQ, and AWQ.",
  },
  {
  ...
  },
  {
    ...
    archiveTitle: "Books That Can make you a Better AI Engineer",
    archiveExcerpt:
